...
Dynamixel allMotors[] = {SHOULDER_R, HIGH_ARM_R, LOW_ARM_R};//, HIGH_ARM_R, HIGH_ARM_L, LOW_ARM_R, LOW_ARM_L, THIGH1_R, THIGH1_L, PELVIS_R, PELVIS_L, THIGH2_R, THIGH2_L, TIBIA_R, TIBIA_L, ANKLE1_R, ANKLE1_L, ANKLE2_R, ANKLE2_L};
...
//    servo_init(&Serial1, 4, SERVO_DARWIN_BAUD);
  ...
  //    servo_loosen_motor(18);
//    servo_changeID_from_to(100,3);
